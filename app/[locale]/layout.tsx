...
export default async function LocaleLayout({
  ...
  const personDescription = isFr
    ...
    : "English-speaking osteopath D.O. in Avignon, France. 16+ years of experience. Graduate of Collège d'Ostéopathie de Provence (Aix-Marseille). Hands-on, holistic, personalized care for adults, athletes, expectant mothers, infants and children.";
